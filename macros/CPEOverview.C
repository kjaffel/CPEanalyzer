// Usage:
// .L CPEOverview.C++
// CPEOverview a1("test.root");
// a1.getOverview()
// a1.printOverview() resp. a1.printOverview("apeOverview.ps",CPEOverview::event)


#include "CPEOverview.h"
...
CPEOverview::CPEOverview(const TString inputFileName):
...
CPEOverview::~CPEOverview(){}



void
CPEOverview::whichModuleInFile(int moduleNo){
  moduleNo_ = moduleNo;
}
...
void
CPEOverview::setSectorsForOverview(const TString& sectors){
  //std::vector<>
...
void
CPEOverview::getOverview(){
  //pluginDir_ = "CPEEstimatorCosmics1/";
...
TString
CPEOverview::setCanvasName()const{
...
void
CPEOverview::eventAndTrackHistos(){
  TString histName;
...
int
CPEOverview::drawHistToPad(const TString histName, const bool setLogScale){
...
int
CPEOverview::setNewCanvas(const PlotDimension& pDim){
...
void
CPEOverview::printOverview(const TString& outputFileName, const HistLevel& histLevel){
