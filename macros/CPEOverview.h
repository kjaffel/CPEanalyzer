#ifndef CPEOverview_h
#define CPEOverview_h
...
class CPEOverview{
   public:
      CPEOverview(const TString inputFileName);
      ~CPEOverview();
      ...
      void printOverview(const TString& outputFileName = "cpeOverview.ps", const HistLevel& histLevel = CPEOverview::event);  //CPEOverview::event, CPEOverview::track, CPEOverview::sector
